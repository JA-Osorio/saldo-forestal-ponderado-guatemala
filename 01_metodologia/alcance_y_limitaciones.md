...
- Las proporciones de recuperación de biomasa a veinte años pueden usarse de forma transparente para ponderar la recuperación dentro de un dominio explícito; sus valores proceden de Poorter et al. (2016).
- La **correspondencia territorial experta codificada** permite repetir exactamente la partición 172/168/2 y los conteos regionales 9/32/62/35/34.
...
Las proporciones regionales se aplican a 172 municipios. Los otros 168 municipios no se imputan con una media nacional y las dos unidades lacustres se mantienen separadas; fuera del dominio se conserva $\rho=1$ en la completación conservadora. Esta decisión limita la aplicación del ponderador y evita presentar una extrapolación como evidencia.
...
| Proporciones de recuperación a veinte años | 172 municipios mediante correspondencia territorial experta codificada | Ponderación de la recuperación |
