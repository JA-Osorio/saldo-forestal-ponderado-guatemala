...
def construir(raiz: Path) -> list[dict[str, str | int]]:
    ...
    for ruta in sorted(raiz.rglob("*")):
        ...
        ) or relativa.parts[0] in EXCLUIR_DIRECTORIOS_RAIZ:
            continue
...
def escribir(
    ...
    salida = directorio_salida or raiz / "05_verificacion"
    salida.mkdir(parents=True, exist_ok=True)
    with (salida / "manifiesto_archivos.csv").open(
    ...
    (salida / "manifiesto_archivos.txt").write_text(texto, encoding="utf-8")
